 ...
 * @author Gavin Monroe
 */
public class SZShape extends AbstractShape implements Shape
{
  ...
  public SZShape(Position givenPosition, boolean magic)
  {
    ...
    cells[2] = new Cell(new Block(Color.GREEN, false), position1);
    
    // another cell just below the second one
    Position position2 = new Position(givenPosition.row() + 1, givenPosition.col());
    cells[1] = new Cell(new Block(Color.GREEN, false), position2);
