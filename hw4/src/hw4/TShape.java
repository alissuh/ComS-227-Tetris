 ...
 * @author Gavin Monroe
 */
public class TShape extends AbstractShape implements Shape
{
  ...
  public TShape(Position givenPosition, boolean magic)
  {
    ...
    cells = new Cell[4];
    cells[1] = new Cell(new Block(Color.MAGENTA, false), givenPosition );
    
    // another cell just below the first one
    Position position1 = new Position(givenPosition.row(), givenPosition.col()+ 1);
    cells[2] = new Cell(new Block(Color.MAGENTA, magic), position1);
    
    // another cell just below the second one
    Position position2 = new Position(givenPosition.row(), givenPosition.col() + 2);
    cells[3] = new Cell(new Block(Color.MAGENTA, false), position2);
    
 // another cell just below the second one
    Position position3 = new Position(givenPosition.row() -1, givenPosition.col() + 1);
    cells[0] = new Cell(new Block(Color.MAGENTA, false), position3);
  }
