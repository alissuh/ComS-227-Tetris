 ...
 * @author Gavin Monroe
 */
public class LShape extends AbstractShape implements Shape
{
  ...
  public LShape(Position givenPosition, boolean magic)
  {
      ...
      Position p1 = new Position(givenPosition.row() + 1, givenPosition.col() - 2);
      cells[1] = new Cell(new Block(Color.ORANGE, false), p1);

      Position p2 = new Position(givenPosition.row() + 1, givenPosition.col() - 1);
      cells[2] = new Cell(new Block(Color.ORANGE, false), p2);

      Position p3 = new Position(givenPosition.row() + 1, givenPosition.col());
